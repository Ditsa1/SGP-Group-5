...
<body>
	<div class="page">
		<div class="d-flex flex-column vh-100 flex-shrink-0 p-3 text-white bg-dark" style="width: 250px; back-ground color: #3a28a7">
			...
			<ul class="nav nav-pills flex-column mb-auto">
				...
				<li> <a href="a_student.php" class="nav-link active"> <span class="ms-2">Students</span> </a> </li>
				...
				<div class="table-title" style="background-color:#a9a9a9">
					<div class="row">
						...
						<div class="col-sm-6">
							...
							<button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#addStudentModal"><i class="material-icons"></i><span>Add New Student</span></button>
