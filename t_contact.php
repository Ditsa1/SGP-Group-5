	...
	<div class="page">
		<div class="d-flex flex-column vh-100 flex-shrink-0 p-3 text-white bg-dark" style="width: 250px;"> <a href="/" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-white text-decoration-none"> <svg class="bi me-2" width="40" height="32"> </svg> <span class="fs-4">Quizard!</span> </a>
			...
			<ul class="nav nav-pills flex-column mb-auto">
				...
				<li> <a href="t_quiz.php" class="nav-link text-white"> <span class="ms-2">Quizzes</span> </a> </li>
				...
				<li> <a href="t_contact.php" class="nav-link active"> <span class="ms-2">Contact</span> </a> </li>
			</ul>
			<hr>
		...
		<div class="container">
			<div class="content container-lg">
				<br>
				<h4 style="background-color:#a9a9a9">Messages</h4>
				<br>
				<table class="table table-bordered">
					<tr>
						<th style="background-color:#a9a9a9">Sr.</th>
						<th style="background-color:#a9a9a9">Username</th>
						<th style="background-color:#a9a9a9">Message</th>
						<th style="background-color:#a9a9a9">Date</th>
					</tr>
					...
					?>
						<tr>
							...
							<td style="background-color:#dddddd"><?= $row['user_name']; ?></td>
							<td style="background-color:#dddddd"><?= $row['c_msg']; ?></td>
							<td style="background-color:#dddddd"><?= $row['c_date']; ?></td>
						</tr>
					<?php
						$i++;
					}
