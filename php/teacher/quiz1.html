...
<div class="container" id="navi">
    <table style="width: 60%;" border="1" align="center">
        <tr>
            <td  align="center" colspan="6"  >
                <input type="text" name="quizName" id="qname" placeholder="Enter Quiz name">
        ...
        <tr>
            <td colspan="6" align="center">
                Correct Option ? <input type="alphabet">
            </td>
        </tr>
        <tr>
             <td colspan="6" align="center">
            Question Difficult ? <input type="range" required min="easy" max="hard">
        </td>
        </tr>
        <tr>
    ...
    <div class="container" id="container">
        <br>
    <button class="btn"><img src="plus.jpg" alt="Add Question" width="30px" >Add Question</button>
</div >
<div class="container">
    <br>
