    ...
    <table align="center" style="width: 60%;" border="1">
        <tr>
            <td rowspan="3" colspan="6">
                <input type="text" placeholder="Subject Name and Code"> 
                
            </td>
            <td align="center" rowspan="2" style="padding-bottom:5px ; padding-top: 20px;" >
                <Button name="Result">Show Result</Button><br>
                <br>
                </td>
        </tr>
    </table>
