    ...
    <div class="container">
            <div class="content container-lg">
                <div class="block mt-3">
                    <input  placeholder="Subject name And Code" class="code"> </input>
                    <div>
                        <button class="bt-start1">Modify</button>
                        <button class="bt-start">delete</button>
                    </div>
                </div>
                <div class="block mt-3">
                    <input  placeholder="Subject name And Code" class="code"> </input>
                    <div>
                        <button class="bt-start">Modify</button>
                        <button class="bt-start">delete</button>
                    </div>
                </div>
                <div class="block mt-3">
